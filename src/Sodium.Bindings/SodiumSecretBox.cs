...
namespace Sodium
{
	...
	/// </summary>
	public static partial class SodiumSecretBox
	{
		...
		/// </list>
		/// </exception>
		/// <exception cref="SodiumException">Thrown when the underlying encryption operation fails.</exception>
		public static Span<byte> EncryptCombined(Span<byte> ciphertext, ReadOnlySpan<byte> plaintext, ReadOnlySpan<byte> key, ReadOnlySpan<byte> nonce)
		{
			...
			if (rc != 0)
			{
				throw new SodiumException("Failed to encrypt message.");
			}
		...
		/// </list>
		/// </exception>
		/// <exception cref="SodiumException">Thrown when decryption or verification fails.</exception>
		...
		/// </list>
		/// </exception>
		/// <exception cref="SodiumException">Thrown when the encryption operation fails.</exception>
